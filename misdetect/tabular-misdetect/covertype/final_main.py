...
if __name__ == '__main__':
    ...
    # 0.6 with 0.5 and clean 10000, bad 1500-1000;
    # 0.9 with 0.3 and bad_pool_len 1500-1000 clean_len 10000
    ...
    #                                   clean_pool_len=10000, bad_pool_len=int(len(train_bad_dataset) / 4) + 5000)
