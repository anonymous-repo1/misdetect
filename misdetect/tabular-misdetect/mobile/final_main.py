...
if __name__ == '__main__':
    ...
    #     detect_num=int(1*(len(train_bad_dataset) / 4)), detect_iterate=4, clean_pool_len=int(len(train_bad_dataset) / 8),
    ...
    # noisy_cross_validation(len(train_clean_bad_set), split_ratio=0.5, epoch=50)
