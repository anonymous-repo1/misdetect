...
train_set_tmp = torchvision.datasets.SVHN(root="data", split='train', transform=transform_train, download=True)

train_set_tmp = train_set_tmp + train_set_tmp + train_set_tmp + train_set_tmp + train_set_tmp + train_set_tmp + train_set_tmp + train_set_tmp+ train_set_tmp+ train_set_tmp
