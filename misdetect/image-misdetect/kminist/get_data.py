...
train_set_tmp = torchvision.datasets.KMNIST(root="data", train=True, transform=transform_train, download=True)
test_set = torchvision.datasets.KMNIST(root="data", train=False, transform=transform_test, download=True)
