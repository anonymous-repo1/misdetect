...
if __name__ == '__main__':
    ...
    # mis injection
    train_clean_dataset, train_bad_dataset, train_clean_bad_set, train_clean_bad_set_ground_truth = mis_injection(
        args.dataset, args.mislabel_ratio, args.mislabel_distribution)

    if args.method == "misdetect":
        misdetect(args.dataset, train_clean_bad_set, train_clean_dataset, train_bad_dataset,
                  train_clean_bad_set_ground_truth)
    elif args.method == "all_methods":
        evaluate_all_methods(args.dataset, train_clean_bad_set, train_clean_dataset, train_bad_dataset,
                             train_clean_bad_set_ground_truth)
        ...
        cleanlab(args.dataset, train_clean_bad_set, train_clean_dataset, train_bad_dataset)
